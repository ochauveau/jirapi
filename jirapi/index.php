...
$tab_sprintId 	= Jira::getSprintIdAll(); 
$tab_var 		= array();
...
foreach ($tab_sprintId as $key => $sprint) {
	...
	foreach ($sprint as $key1 => $sprintId) {
		...
		$tab_var[$key]['velocity_and_engagement'] 	= "Done : ".$velocity_and_engagement['velocity']."<span class='mini'>pts</span> / ".$velocity_and_engagement['engagement'];
